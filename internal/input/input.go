...
//         "numerical",
//         f"How much would you like to contribute every {
//             additional_contribution_frequency}? ",
//         testing=testing
//     )
//
...
//     print("---------------------------------------")
//
//     additional_contribution_confirmation = collect_input(
